...
<html lang="fr">
  <head>
    <title>Est-ce végétalien ? - VeganCheck.me</title>
    <meta charset="UTF-8">

    <meta name="description" content="Vérifier si un produit est végétalien avec VeganCheck.me">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta property="og:title" content="Est-ce végétalien ? - VeganCheck.me">
      ...
      <div id="main">
        ...
        <form action="script.php">
          <fieldset>
            ...
            <input type="number" id="barcode" name="barcode" placeholder="Entrez le code à barres des produits" autofocus> 
        ...
        <div id="result">&nbsp;</div>
        <footer>
          <p>Codé avec <i class="icon-love"></i> par <a href="https://philipbrembeck.com">Philip Brembeck</a> &amp; <a href="https://jokenetwork.de">JokeNetwork</a>
            <br><a href="privacy-policy">Politique de confidentialité</a> / <a href="impressum">Mentions légales</a> / <a href="//github.com/sponsors/philipbrembeck/">Sponsor</a></p>
