		...
		if(isset($array)){
			...
			elseif (in_array("en:palm-oil-free", $array)) {
				...
				elseif (in_array("en:vegan", $array)) {
					echo '<div class="animated fadeIn"><span class="vegan">"<span class="name">'.$name.'</span>":<br>Vegan<span class="icon-ok"></span> </span>'.$palmoil.$nutriscore.'<a href="https://twitter.com/intent/tweet?url=https://vegancheck.me&text='.$name.'%20ist%20vegan!%20-%20Geprüft%20mit%20" class="btn-dark"><span class="icon-twitter"></span> Tweet</a></div>';
				}
