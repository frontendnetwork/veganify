		...
		if(isset($array)){
			...
			elseif (in_array("en:palm-oil-free", $array)) {
				...
				elseif (in_array("en:vegan-status-unknown", $array) or in_array("en:maybe-vegan", $array)) {
				    echo  '<div class="animated fadeIn"><span class="unknown">"<span class="name">'.$name.'</span>":<br>Vegan<span class="icon-help"></span> </span>'.$palmoil.$nutriscore.'<br><a href="https://world.openfoodfacts.org/cgi/product.pl?type=edit&code='.$barcode.'" class="btn-dark">Produkt ändern</a></div>';
				}
