...
After translating, please delete any comments (like this one).

Please don't forget to also translate the frontpage which can be found at localization/template.php
...
$notvegan = 'Not vegan';
$tweettext = '%20is%20not%20vegan!%20-%Checked%with%20'; // Please keep '%20' as spaces
$tweettextvegan = '%20is%20vegan!%20-%Checked%20with%20'; // Please keep '%20' as spaces
$edit = 'Edit';
?>
