...
<html lang="de">
  <head>
    ...
    <link href="css/style.min.css?v=3.9" rel="stylesheet">
  </head>
  ...
  <body>
    <div class="container">
      <div id="main">
        ...
        <div id="result">&nbsp;</div> 
        <footer>
          <p>Mit <i class="icon-vegancheck"></i> gemacht von <a href="https://philipbrembeck.com">Philip Brembeck</a> &amp; <a href="https://jokenetwork.de">JokeNetwork</a>
