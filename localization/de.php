...
$langArray = array(
        ...
        "footer" => array(
        	...
        	"legal" => '<a href="privacy-policy">Datenschutzerklärung</a> / <a href="impressum">Impressum</a> / <a href="//github.com/sponsors/philipbrembeck/">Sponsor werden</a>'
        ),
        "pwa" => array(
        	"close" => "Schließen",
        	"install" => "VeganCheck instalieren",
        	"description" => "Installiere VeganCheck auf deinem Home-Bildschirm und scanne immer und überall Produkte und überprüfe, ob Sie vegan sind!",
