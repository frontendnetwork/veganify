...
$langArray = array(
        ...
        "results" => array(
        	...
        	"add" => "¿Quiere añadirlo?",
        	"addonoff" => "Añade este producto en OpenFoodFacts",
