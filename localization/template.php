...
Please note: Please only translate text which is marked with ⬅.
After translating, please delete any comments (like this one) except the one below <!DOCTYPE html>.
...
<!-- Please specifiy language here -->
<!--        ⬇︎ -->
<html lang="en">
  <head>
    <!-- The sites title, only change the "Is it vegan?"-part -->
    <title>Is it Vegan?<!-- ⬅-->- VeganCheck.me</title>
    <meta charset="UTF-8">

    <!-- The sites description for text preview in search engines -->
  ...
  <body>
    <div class="container animated zoomIn">
      <div id="main">
        ...
        <form action="script.php">
          <fieldset>
            <span class="btn_scan" onclick="setupLiveReader()" aria-label="Scan Barcode" role="button"><!-- ⬅ ("Scan Barcode") --><i class="icon-barcode"></i></span>
            <input type="number" id="barcode" name="barcode" placeholder="Enter product barcode" autofocus><!-- ⬅ ("Enter product barcode") --> 
            <input type="hidden" id="lang" name="lang" value="en"><!-- ⬅ Change "en" to the language you're translating to -->
        ...
        <footer>
          <!-- Footer part -->
          <p>Made with <i class="icon-vegancheck"></i><!-- displays a heart --> by <!-- ⬅--><a href="https://philipbrembeck.com">Philip Brembeck</a> &amp; <a href="https://jokenetwork.de">JokeNetwork</a>
    ...
    <div class="pwa-install-prompt__container">
            <!-- Install on homescreen prompt for smartphones -->
