...
export default function InstallPrompt() {
  ...
  return (
    <div id="pwainstall" style={{ display: showInstallPrompt ? "block" : "none" }}>
      <div className="flex-container">
        ...
        <div className="flex-item">
          ...
          >
            ...
            <p dangerouslySetInnerHTML={{ __html: t('howtoinstall', {share: '<Image src="../img/pwa_share.svg" width="16" height="16" alt="Share" />'})}} />
          </ModalWrapper>
        </div>
      </div>
    </div>
