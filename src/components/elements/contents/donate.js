...
const SupportOption = () => {
    ...
    const [supportBtnLink, setSupportBtnLink] = useState('https://www.paypal.com/donate/?hosted_button_id=J7TEA8GBPN536');
    ...
    const handleOptionOnceClick = () => {
      ...
      setSupportBtnLink('https://www.paypal.com/donate/?hosted_button_id=J7TEA8GBPN536');
      setOnceChecked(true);
      setGhChecked(false);
    ...
    return (
      ...
      <span class="center">
        ...
        <div className={`option ${onceChecked ? "active" : ""}`} id="option_once" onClick={handleOptionOnceClick}>
          <input
        ...
        <div className={`option ${KofiChecked ? "active" : ""}`} id="option_kofi" onClick={handleOptionKofiClick}>
            <input class="form-check-input" type="radio" name="flexRadioDefault" id="kofi" checked={KofiChecked} />
            <span class="muted">{t('onceviakofi')}</span>
            <span class="price">1-50€</span>
          </div>
        <div className={`option ${ghChecked ? "active" : ""}`} id="option_gh" onClick={handleOptionGhClick}>
          <input
            className="form-check-input"
            type="radio"
            name="flexRadioDefault"
        ...
        <span class="info">{t('redirect')} <span id="vendor">{vendor}</span>.</span>
        </div>
      </>
    );
  };
